...
"<br/>"+"Tubo los siguientes recargos:<br/>"+"Recargo por edad: "+comision1+"%<br/>"+"Recargo por edad de conyuge: "+
comision2+"%<br/>"+"Recargo por hijos: "+comision3+"%<br/>"+"SU TOTAL A PAGAR ES: "+totalapagar);
